    ...
    return (
        <View className="">
            <View className="w-full h-full bg-white">
                ...
                {/*Title and Form*/}
                <View className="flex justify-around w-full h-full pt-48 pb-10">
                    ...
                    <View className="flex items-center mx-4 space-y-4">
                        ...
                        <Animated.View entering={FadeInDown.delay( 400 ).duration( 1000 ).springify()} className="w-full p-5 m-5 bg-black/5 rounded-2xl">
